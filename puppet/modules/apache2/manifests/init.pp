...
class apache2::install {
  ...
  file { '/etc/apache2/sites-available/yii.conf':
    source  => '/vagrant/files/etc/apache2/sites-available/yii.conf',
  }
  ...
  file { '/etc/apache2/sites-enabled/000-yii.conf':
    ensure  => link,
    target  => '/etc/apache2/sites-available/yii.conf',
  }
